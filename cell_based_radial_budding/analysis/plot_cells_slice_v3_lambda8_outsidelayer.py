...
cG0=min(1.,max(0.,1.-2.5*abs(1./(0.012*d*radius[frameplot]))))
cG1=min(1.,max(0.,1.-2.5*abs(1./(0.012*d*radius[frameplot+1]))))
cG2=min(1.,max(0.,1.-2.5*abs(1./(0.012*d*radius[frameplot+2]))))
cG3=min(1.,max(0.,1.-2.5*abs(1./(0.012*d*radius[frameplot+3]))))
cB0=min(1.,max(0.,1./(0.01*d*radius[frameplot])))

cB1=min(1.,max(0.,1./(0.01*d*radius[frameplot+1])))
cB2=min(1.,max(0.,1./(0.01*d*radius[frameplot+2])))
cB3=min(1.,max(0.,1./(0.01*d*radius[frameplot+3])))
...
plt.plot([-60.,0.,60.],[116.,0.,116.],'w',linewidth=6)
...
plt.yticks([])
plt.axis('off')
plt.savefig('system_forward_slice_v3_lambda8_lightoutside.pdf')
plt.savefig('system_forward_slice_v3_lambda8_lightoutside.png')
plt.show() 
